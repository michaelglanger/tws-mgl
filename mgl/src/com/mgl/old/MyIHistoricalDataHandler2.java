...
public class MyIHistoricalDataHandler2 implements IHistoricalDataHandler, Callable<Void>, ApiController.ITopMktDataHandler {
...
//    private boolean historical = true;
    ...
    public MyIHistoricalDataHandler2(NewContract nc, ApiController apiController, String endDateTime) {
        this.nc = nc;
